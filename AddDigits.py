...
# TC: O(1) because we are using a constant amount of time to compute the result using the formula.
# SC: O(1) because we are using a constant amount of space to store the input number and the result.